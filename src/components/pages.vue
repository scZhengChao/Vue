<template>
    <div>
          <section class="aui-flexView">
            ...
            <header class="aui-navBar">
                ...
                <div class="aui-navBar-center">
                    <span class="aui-navBar-title">娱乐新闻网</span>
                </div>
            ...
            <section class="aui-scrollView">
                <div class="aui-content">
                    <div class="aui-special-box">
                        ...
                        <div class="aui-pages-img">
                            <img src="../assets/themes/img/ad/page1.jpg" alt="">
                        </div>
                        <div class="aui-pages-title">
                        ...
                        <div class="aui-pages-img">
                            <img src="../assets/themes/img/ad/page2.jpg" alt="">
                        </div>
                        <div class="aui-pages-img">
                            <img src="../assets/themes/img/ad/page3.jpg" alt="">
                        </div>
                        <div class="aui-pages-img">
                            <img src="../assets/themes/img/ad/page4.jpg" alt="">
                        </div>
                        <div class="aui-pages-title">
                        ...
                        <div class="aui-comment-box">
                            <div class="aui-comment-cell">
                                <div class="aui-comment-list">
                                    <div class="aui-comment-head">
                                        <img src="../assets/themes/img/user/head.jpg" alt="">
                                    </div>
                                    <div class="aui-comment-text">
                                        <h2>C壹壹C同学</h2>
                                        <p>这个真的很漂亮 赞一下 某宝上面上面时候出同款啊 ，等着秒杀呐 喜欢迪丽热巴 的🌹🌹🌹🌹 🙋🌺🌹</p>
                                    </div>
                                    <div class="aui-comment-zan">129 赞</div>
                                </div>
                            </div>
                            <div class="aui-comment-cell">
                                <div class="aui-comment-list">
                ...
                <footer class="aui-pages-footer aui-footer-fixed">
                    <div class="aui-pages-footer-box">
                        <div class="aui-pages-footer-input">
                            <input type="text" placeholder="我来说俩句...">
                        </div>
                        <div class="aui-pages-footer-title">
                            <span>
                                <img src="../assets/themes/img/icon/btn1.png" alt="">
                            </span>
                            <span>
                                <img src="../assets/themes/img/icon/btn2.png" alt="">
                            </span>
                            <span>
                               <img src="../assets/themes/img/icon/btn3.png" alt="">
                            </span>
                        </div>
                    </div>
                </footer>
        ...
        <div class="m-actionsheet" id="actionSheet">
            <div class="aui-share-list">
                <ul class="clearfix">
                    <li>
                        <a href="#">
                            <span>
                                <img src="../assets/themes/img/icon/icon-s1.png" alt="">
                            </span>
                            <span>QQ空间</span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <span>
                                <img src="../assets/themes/img/icon/icon-s2.png" alt="">
                            </span>
                            <span>QQ好友</span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <span>
                                <img src="../assets/themes/img/icon/icon-s3.png" alt="">
                            </span>
                            <span>微信好友</span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <span>
                                <img src="../assets/themes/img/icon/icon-s4.png" alt="">
                            </span>
                            <span>新浪微博</span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <span>
                                <img src="../assets/themes/img/icon/icon-s5.png" alt="">
                            </span>
                            <span>朋友圈</span>
                        </a>
                    </li>
	                <li>
		                <a href="#">
                            <span>
                                <img src="../assets/themes/img/icon/icon-s6.png" alt="">
                            </span>
			                <span>邮箱</span>
		                </a>
	                </li>
	                <li>
		                <a href="#">
                            <span>
                                <img src="../assets/themes/img/icon/icon-s7.png" alt="">
                            </span>
			                <span>复制链接</span>
		                </a>
	                </li>
            ...
            <a href="javascript:;" class="aui-cancel" id="cancel">取消分享</a>
        </div>
    </div>
</template>
<script>
