...
<style scoped>
  ...
  .content h1{width:2.18rem;height:1.35rem; background:url(../assets/themes/img/my_cz.png) no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:1.22rem;}
